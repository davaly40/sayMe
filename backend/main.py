...
COMMANDS: Dict[str, str] = {
    ...
    "šta možeš": "Mogu ti pomoći s mnogim stvarima, na primjer brzo doći do relevantnih informacija ili te odvesti do najbližeg restorana, navigirati do željene adrese i slično.",
    "šta ti možeš": "Mogu ti pomoći s mnogim stvarima, mogu ti reći kakvo je vrijeme ili ovoriti aplikaciju za tebe.",
    "možeš li na net": "Mogu surfat internetom ali samo u svrhu prikupljanja podataka kako bi adekvatno mogao odgovoriti na tvoja pitanja.",
    "možeš li na internet": "Mogu surfat internetom ali samo za prikupljanje podataka da ti dam adekvatan odgovor na tvoje pitanje.",
    ...
    "pokaži mi što možeš": "Možeš mi reći: odvedi me do najbiližeg restorana, otvori mi aplikaciju, upali glazbu, reci mi vremensku prognozu, ili jednostavno pitaj što te zanima.",
    ...
    "jesi li ti umjetna inteligencija": "Ne, ja sam automatizirani program.",
    "jesi li ti AI": "Ne, ja sam automatizirani program.",
    "koja razlika je između tebe i umjetne inteligencije": "Umjetna inteligencija sama odlučuje o svojim akcijama, dok ja radim prema unaprijed definiranim pravilima.",
    ...
    "broj za hitnu pomoć": "Broj za hitnu pomoć je 194",
    "broj za hitnu": "Broj za hitnu pomoć je 194",
